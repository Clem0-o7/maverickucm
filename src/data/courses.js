...
export const courses = [
  {
    ...
    tagline: 'Physics, Chemistry, Mathematics & Biology — everything you need for boards and foundation.',
    subjects: ['Physics', 'Chemistry', 'Mathematics', 'Biology'],
    duration: 'Till Board Exam',
    mode: 'Live Online + Recorded',
    batchStarts: '15th July 2026',
    seatsTotal: 80,
    seatsLeft: 23,
    feeDiscounted: 4999,
    feeOriginal: 9999,
    ...
    mentors: [
      {
        ...
        coursePlanPdf: '/pdfs/Physics_Lecture_Planner_Final.pdf',
      },
      {
        id: 'f2',
        name: 'Saravanan Sir',
        ...
        coursePlanPdf: '/pdfs/Chemistry_Lecture_Planner_Final.pdf',
      },
      {
        id: 'f3',
        name: 'Rethik Raj Sir',
      ...
      },
      {
        ...
        coursePlanPdf: '/pdfs/Biology_Lecture_Planner_Final.pdf',
      }
    ],
  },
